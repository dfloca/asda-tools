                ...
                <Table striped bordered hover>
                    ...
                    <tbody>
                        <tr>
                            <td>Helmet</td>
                            <td>
                                <Form.Check type="switch" id="helmet-switch" defaultChecked="false" value="false"/>
                            </td>
                            <td>
                                <Sowels id='helm-primary-sowel' value="Stamina"></Sowels>
                            </td>
                            <td>
                                <Form.Control id='helm-primary-value' placeholder='Sowel Value' defaultValue="0"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <Sowels id='helm-secondary-sowel' value="Stamina"></Sowels>
                            </td>
                            <td>
                                <Form.Control id='helm-secondary-value' placeholder='Sowel Value' defaultValue="0"/>
                            </td>
                        </tr>
                        {/* <tr>
                            <td>Chest</td>
